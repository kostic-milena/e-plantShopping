   ...
   const styleA={
    ...
    return (
        <div>
            ...
            <div className="tag">
               <div className="luxury" style={{cursor:"pointer"}} onClick={props.toLanding}>
            ...
            <div style={styleObjUl}>
                ...
                <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                    <h1 className='cart'>
                        <label className='pointer'>{totalItems()}</label>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">0<rect width="156" height="156" fill="none"></rect>
